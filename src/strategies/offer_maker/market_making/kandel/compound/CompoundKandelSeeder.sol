...
contract CompoundKandelSeeder is AbstractKandelSeeder {
    ...
    returns (GeometricKandel kandel)
  {
    ...
    CompoundV2Router router = _deployRouter();
  ...
  /// @notice Deploys a new instance of CompoundV2Router using the router deployer
  /// @return The address of the newly deployed CompoundV2Router.
  function _deployRouter() internal virtual returns (CompoundV2Router) {
