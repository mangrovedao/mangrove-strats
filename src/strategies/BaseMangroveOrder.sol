...
import {AbstractRouter} from "./routers/abstract/AbstractRouter.sol";

///@title BaseMangroveOrder. A periphery contract to Mangrove protocol that implements "Good till cancelled" (GTC) orders as well as "Fill or kill" (FOK) orders.
