...
contract AmplifierDeployer is Deployer {
   ...
   */
  function innerRun(IPermit2 permit2, IMangrove mgv, address admin, IERC20 base, IERC20 stable1, IERC20 stable2) public {
    ...
    broadcast();
    Amplifier amplifier = new Amplifier(permit2, mgv, base, stable1, stable2, admin );
